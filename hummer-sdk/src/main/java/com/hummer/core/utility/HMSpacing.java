 ...
 * marginHorizontal.
 */
public class HMSpacing {

    /**
     * HMSpacing type that represents the left direction. E.g. {@code marginLeft}.
     */
    public static final int LEFT = 0;
    /**
     * HMSpacing type that represents the top direction. E.g. {@code marginTop}.
     */
    public static final int TOP = 1;
    /**
     * HMSpacing type that represents the right direction. E.g. {@code marginRight}.
     */
    public static final int RIGHT = 2;
    /**
     * HMSpacing type that represents the bottom direction. E.g. {@code marginBottom}.
     */
    public static final int BOTTOM = 3;
    /**
     * HMSpacing type that represents start direction e.g. left in left-to-right, right in right-to-left.
     */
    public static final int START = 4;
    /**
     * HMSpacing type that represents end direction e.g. right in left-to-right, left in right-to-left.
     */
    public static final int END = 5;
    /**
     * HMSpacing type that represents horizontal direction (left and right). E.g.
     * {@code marginHorizontal}.
     */
    public static final int HORIZONTAL = 6;
    /**
     * HMSpacing type that represents vertical direction (top and bottom). E.g. {@code marginVertical}.
     */
    public static final int VERTICAL = 7;
    /**
     * HMSpacing type that represents all directions (left, top, right, bottom). E.g. {@code margin}.
     */
    ...
    public HMSpacing(float defaultValue) {
        mDefaultValue = defaultValue;
        mSpacing = newFullSpacingArray();
    }

    public HMSpacing(HMSpacing original) {
    ...
    public boolean set(int spacingType, float value) {
        if (!HMFloatUtil.floatsEqual(mSpacing[spacingType], value)) {
     ...
     * recycling {@link HMSpacing} instances.
     */
    public void reset() {
        Arrays.fill(mSpacing, UNDEFINED);
